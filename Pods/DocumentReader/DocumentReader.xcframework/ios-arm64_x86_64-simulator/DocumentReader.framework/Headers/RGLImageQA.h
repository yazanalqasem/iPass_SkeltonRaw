...
/// This parameter sets threshold for Image QA check of the presented document brightness.
/// If actual document brightness is above this threshold, check will fail.
/// Type: Double.
